...
export type DesignWorkspaceId = "space" | "renovation" | "furniture" | "mep" | "finishes";
...
const modeWorkspaceMap: Partial<Record<PlanCanvasMode, DesignWorkspaceId>> = {
  sitePlan: "space", structurePlan: "space", demolitionAndBuildPlan: "renovation", furniturePlan: "furniture",
