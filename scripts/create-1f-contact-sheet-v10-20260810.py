...
SOURCE = ROOT / "artifacts/1f-final-ten-views-v10/final"
OUTPUT = ROOT / "artifacts/1f-final-ten-views-v10/boards/03-final-render-contact-sheet-v10.png"
...
labels = [
    ...
    "04 沙发正对电视壁炉 · 本轮重做",
    "05 水吧正立面 · 已确认",
    "06 厨房入口与900mm客卫门 · 本轮重做",
    "07 厨房朝南看客餐厅 · 已确认",
    "08 客卫正面与北窗 · 已确认",
    "09 左下B1 / 右上2F与唯一卧室门 · 本轮重做",
    "10 卧室与飘窗 · 家具布局待复核",
]
...
draw.text((margin, 28), "1F 十机位写实效果图 · V10", font=font_title, fill="#2F2924")
draw.text((margin, 72), "02 / 04 / 06 / 09 为本轮修正；10 号仅确认空间拓扑，不确认当前床柜组合。", font=font_note, fill="#786B60")
...
for index, (file, label) in enumerate(zip(files, labels)):
    ...
    framed = ImageOps.fit(source, (cell_w, image_h), method=Image.Resampling.LANCZOS, centering=(0.5, 0.5))
