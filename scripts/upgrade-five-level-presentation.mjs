...
const newFurniture = [
  ...
  { id: "ph-1f-north-yard-gate", code: "YG-1F-N", name: "北院庭院门", type: "custom", floorId: "1F", roomId: "OD-1F-NORTH-001", dimensions: { width: 130, depth: 14, height: 180, unit: "cm" }, material: "深灰金属格栅", note: "入户庭院门占位。", constructionNote: "复核门柱、门禁、电源、排水和开启净宽。", position: { x: 43.5, y: -15.8, rotation: 0 }, color: "#3f4447" },
  ...
  { id: "ph-1f-north-outdoor-socket", code: "SO-1F-N", name: "北院防水户外插座", type: "custom", floorId: "1F", roomId: "OD-1F-NORTH-001", dimensions: { width: 18, depth: 10, height: 45, unit: "cm" }, material: "深灰防水盒", note: "烧烤和清洁设备地插/墙插占位。", constructionNote: "防水盒、漏保和独立回路，离积水点保持安全距离。", position: { x: 30, y: -9, rotation: 0 }, color: "#3f4447" },
  ...
  { id: "ph-1f-south-drain-point", code: "DR-1F-S", name: "南院排水点 / 地漏", type: "custom", floorId: "1F", roomId: "OD-1F-SOUTH-001", dimensions: { width: 35, depth: 35, height: 4, unit: "cm" }, material: "深灰金属地漏", note: "户外柜与宠物角附近排水占位。", constructionNote: "结合庭院坡度、雨水管和清洗排水复核。", position: { x: 72, y: 115, rotation: 0 }, color: "#62686b" }
];
