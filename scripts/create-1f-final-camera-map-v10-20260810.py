...
SOURCE = ROOT / "artifacts/1f-final-ten-views-v10/boards/01-1f-furniture-plan.png"
OUTPUT = ROOT / "artifacts/1f-final-ten-views-v10/boards/02-1f-camera-map-v10.png"
WORKSPACE = ROOT / "data/default-workspace.json"

workspace = json.loads(WORKSPACE.read_text(encoding="utf-8"))
# V10 follows the numbering used in the user's latest review: kitchen-to-living
...
draw.text((88, 91), "1F 十机位 V10 · 圆点=机位 / 箭头=朝向", font=font_title, fill="#2F2924")
legend = [
    "01  入户三向关系",
    "02  玄关朝东南看客厅",
    "03  客餐厅与电动圆桌",
