...
SOURCE = ROOT / "artifacts/1f-final-ten-views-v11/final"
OUTPUT = ROOT / "artifacts/1f-final-ten-views-v11/boards/03-final-render-contact-sheet.png"
...
draw.text((margin, 28), "1F 十机位写实效果图 · V11", font=font_title, fill="#2F2924")
draw.text((margin, 72), "十张全部重新生成；严格锁定当前平面、门窗、楼梯与家具方向。", font=font_note, fill="#786B60")
