...
SOURCE = ROOT / "artifacts/1f-final-ten-views-v13/final"
OUTPUT = ROOT / "artifacts/1f-final-ten-views-v13/boards/03-final-render-contact-sheet.png"
...
draw.text((margin, 28), "1F 十机位写实效果图 · V13", font=font_title, fill="#2F2924")
draw.text(
    (margin, 72),
    "01客厅露景、04电视墙与09楼梯机位已按复核结果修正。",
    font=font_note,
    fill="#786B60",
)
